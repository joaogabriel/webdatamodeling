...
DESCRIPTION: 
	...
	which it controls, adding three important capabilities:
		...
		1) Dynamically define a custom registration point (actually a Vector3D) around which all transformations (like rotation, 
...
PROPERTIES ADDED WITH TweenProxy3D:
	...
	- registration : Vector3D
	- registrationX : Number
	- registrationY : Number
	- registrationZ : Number
	- localRegistration : Vector3D
