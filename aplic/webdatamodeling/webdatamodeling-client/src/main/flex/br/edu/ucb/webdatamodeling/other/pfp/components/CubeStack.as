package br.edu.ucb.webdatamodeling.other.pfp.components
{
	import br.edu.ucb.webdatamodeling.other.adobe.ac.mxeffects.CubeRotate;
	import br.edu.ucb.webdatamodeling.other.pfp.events.CubeRotateEvent;
	import br.edu.ucb.webdatamodeling.other.pfp.events.CubeSideChangeEvent;
